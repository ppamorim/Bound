...
public class LineMorphingDrawable extends Drawable implements Animatable{
  ...
  private LineMorphingDrawable(State[] states, int curState, int paddingLeft, int paddingTop,
      int paddingRight, int paddingBottom, int animDuration, Interpolator interpolator,
      int strokeSize, int strokeColor, Paint.Cap strokeCap, Paint.Join strokeJoin,
      boolean clockwise, boolean isRtl){
    mStates = states;
  ...
  public static class Builder{
    ...
    public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
      ...
      strokeSize(a.getDimensionPixelSize(R.styleable.LineMorphingDrawable_lmd_strokeSize, ViewUtil.dpToPx(context, 3)));
