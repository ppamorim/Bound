...
public class FloatingActionButtonOld extends View {
  ...
  public static FloatingActionButtonOld make(Context context, int resId){
    return new FloatingActionButtonOld(context, null, resId);
  }
  ...
  public FloatingActionButtonOld(Context context, AttributeSet attrs) {
  ...
  private void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    int radius = a.getDimensionPixelSize(R.styleable.FloatingActionButton_fab_radius, ViewUtil.dpToPx(context, 28));
    int elevation = a.getDimensionPixelSize(R.styleable.FloatingActionButton_fab_elevation, ViewUtil.dpToPx(context, 4));
    int bgColor = a.getColor(R.styleable.FloatingActionButton_fab_backgroundColor, ViewUtil.colorAccent(context, 0xFFFAFAFA));
    ...
    mIconSize = a.getDimensionPixelSize(R.styleable.FloatingActionButton_fab_iconSize, ViewUtil.dpToPx(context, 24));
  ...
  public void updateLocation(int x, int y, int gravity){
    if(getParent() != null)
      ...
      Log.v(FloatingActionButtonOld.class.getSimpleName(), "updateLocation() is called without parent");
  }
  ...
  private void setLeftMargin(ViewGroup.LayoutParams params, int value){
    if(params instanceof FrameLayout.LayoutParams)
      ...
      Log.v(FloatingActionButtonOld.class.getSimpleName(), "cannot recognize LayoutParams: " + params);
  }
  ...
  static class SavedState extends BaseSavedState {
    ...
    /**
     * Constructor called from {@link Parcelable()}
     */
  ...
  class SwitchIconAnimator implements Runnable{
    ...
    public boolean startAnimation(Drawable icon) {
      ...
      float half = mIconSize / 2f;
      mIcon.setBounds((int)(mBackground.getCenterX() - half), (int)(mBackground.getCenterY() - half), (int)(mBackground.getCenterX() + half), (int)(mBackground.getCenterY() + half));
      mIcon.setCallback(FloatingActionButtonOld.this);
